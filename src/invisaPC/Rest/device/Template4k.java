 ...
 *
 */
public class Template4k extends StartupTestCase {
	
	final static Logger log = Logger.getLogger(Template4k.class);
	...
	private String edidDvi1 = "1920x1080p-60Hz";			///return from rest : 0
	...
	private String templateTx = "TemplateTestTX4k";
	private String templateRx = "TemplateTestRX4k";
...
//			checkSystemProperties(true, true);
			...
			deviceMethods.addTemplateTransmitter(driver, templateTx, "Best Quality",
					"Off", "Default", "Analog", "5", "Default", "1680x1050");
	...
	public void test03_checkTemplateEdidDefault() {
	...
	public void test15_checkTemplateChangeHidDefault() throws InterruptedException {
		...
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "Default", "Analog", "5", "Default", "1920x1200");
	...
	public void test16_checkTemplateChangeHidBasic() throws InterruptedException {
		...
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "Basic", "Analog", "5", "Default", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);
	...
	public void test17_checkTemplateChangeHidMac() throws InterruptedException {
		...
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "MAC", "Analog", "5", "Default", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);
	...
	public void test17_checkTemplateChangeHidAbsolute() throws InterruptedException {
		log.info("***** test17_checkTemplateChangeHidMac *****");
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "Absolute", "Analog", "5", "Default", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);
	 ...
	 */
	@Test(groups= {"rest", "emerald2", "notEmerald"})
	public void test18_checkTemplateChangeEdid1_3840x2160p60Hz() throws InterruptedException {
		log.info("***** test18_checkTemplateChangeEdid1_3840x2160p60Hz *****");
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "MAC", "Analog", "5", "3840x2160p-60Hz", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);
	 ...
	 */
	@Test(groups= {"rest", "emerald2", "notEmerald"})
	public void test19_checkTemplateChangeEdid1_3840x2160p30Hz() throws InterruptedException {
		log.info("***** test19_checkTemplateChangeEdid1_3840x2160p30Hz *****");
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "MAC", "Analog", "5", "3840x2160p-30Hz", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);
	 ...
	 */
	@Test(groups= {"rest", "emerald2", "notEmerald"})
	public void test20_checkTemplateChangeEdid1_2560x1440p60Hz() throws InterruptedException {
		log.info("***** test20_checkTemplateChangeEdid1_2560x1440p60Hz *****");
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "MAC", "Analog", "5", "2560x1440p-60Hz", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);
	 ...
	 */
	@Test(groups= {"rest", "emerald2", "notEmerald"})
	public void test21_checkTemplateChangeEdid1_1920x1080p60Hz() throws InterruptedException {
		log.info("***** test21_checkTemplateChangeEdid1_1920x1080p60Hz *****");
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "MAC", "Analog", "5", "1920x1080p-60Hz", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);
	...
	public void test25_checkMouseKeyboard0() throws InterruptedException {
		...
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "MAC", "Analog", "0", "Default", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);
	...
	public void test26_checkMouseKeyboard1() throws InterruptedException {
		...
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "MAC", "Analog", "1", "Default", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);
	...
	public void test27_checkMouseKeyboard2() throws InterruptedException {
		...
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "MAC", "Analog", "2", "Default", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);
	...
	public void test28_checkMouseKeyboard3() throws InterruptedException {
		...
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "MAC", "Analog", "3", "Default", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);
	...
	public void test29_checkMouseKeyboard4() throws InterruptedException {
		...
		deviceMethods.editTemplateTransmitter(driver, templateTx, "4", "VGA - Low Bandwidth", "MAC", "Analog", "4", "Default", "1920x1200");
		log.info("Sleeping while device reconfigures");
		deviceMethods.checkReboot(txIp, deviceUserName, devicePassword);

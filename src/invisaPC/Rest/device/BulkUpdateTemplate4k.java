 ...
 *
 */
public class BulkUpdateTemplate4k extends StartupTestCase {
	
	final static Logger log = Logger.getLogger(BulkUpdateTemplate4k.class);
...
//			Thread.sleep(timeout);
			...
			deviceMethods.addTemplateTransmitter(driver, txTemplateName, "Best Quality",
					"Off", "Default", "Analog", "5", "3840x2160p-30Hz", "1680x1050");

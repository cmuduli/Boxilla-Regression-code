...
java -cp C:\Test_Workstation\SeleniumAutomation\lib\*;C:\Test_Workstation\SeleniumAutomation\bin -Drelease=%LAST% -Dbrowser=%Browser% -Demerald=%emerald% -Demeraldse=%emeraldse% org.testng.TestNG soaktestFull.xml
REM call ant
